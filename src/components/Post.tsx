...
const Post = ({
  ...
  return (
    <div className="w-64 flex justify-center font-body font-light">
      <div className="">
        <div
          id={isPreview && post.color === "" ? "post-preview" : ""}
          className={
            "flex flex-col aspect-square rounded-3xl text-center justify-center items-center relative shadow-lg" +
            (post.color == ""
              ? " bg-gradient-to-br from-orange-500 via-pink-500 to-purple-500 "
              : " ") +
            (!isPreview ? "shadow-black" : " ")
          }
          style={{
        ...
        >
          <p
            className={
              "text-2xl opacity-80" +
              (post.color === "" &&
                "font-black text-4xl text-black aspect-square p-10 bg-transparent")
            }
          >
